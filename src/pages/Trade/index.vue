  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" 
        ...
        <span class="username" :class="{ selected: selectedAddress === userAddress }">{{ userAddress.consignee }}</span>
        <p>
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="goodDetail in detailArrayList" :key="goodDetail.skuId">
          <li>
            <img style="width: 100px; height: 100px;" :src="goodDetail.imgUrl" alt="">
          </li>
          <li>
            <p>{{ goodDetail.skuName }}</p>
            <h4>7天无理由退货</h4>
          </li>
          <li>
            <h3>￥{{ goodDetail.orderPrice }}</h3>
          </li>
    ...
    <div class="sub clearFix">
      <a class="subBtn" href="javascript:;" @click="toPay">提交订单</a>
    </div>
  </div>
</template>
